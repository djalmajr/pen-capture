...
test("builds a safe Pencil MCP insertion batch", () => {
  const script = buildBatchScript({ format:"pencil-node-tree", version:1, root:{ type:"frame", name:"Captured · Card", width:200, height:100, children:[{type:"text",name:"Title",content:"Hello"}] } });
